...
WORKDIR /src
COPY ["serverless-app-with-dynamo-example.csproj", "serverless-app-with-dynamo-example/"]
RUN dotnet restore "serverless-app-with-dynamo-example/serverless-app-with-dynamo-example.csproj"

WORKDIR "/src/serverless-app-with-dynamo-example"
COPY . .
RUN dotnet build "serverless-app-with-dynamo-example.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "serverless-app-with-dynamo-example.csproj" \
...
Execute unit tests
```
    cd "serverless-app-with-dynamo-example/test/serverless-app-with-dynamo-example.Tests"
    dotnet test
```

Deploy application
```
    cd "serverless-app-with-dynamo-example/src/serverless-app-with-dynamo-example"
